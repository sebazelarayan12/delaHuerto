  ...
  return (
    <AdminLayout>
      <div style={{ padding: '32px 32px 0', borderBottom: '1px solid #E2CFB5', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1 style={{ fontSize: 24, fontWeight: 800, color: '#2C1208' }}>Categorías</h1>
              ...
              <tbody>
                {[...categorias].sort((a, b) => a.orden - b.orden).map((cat, i) => (
                  <tr
                    key={cat.id}
                    style={{
                      borderBottom: i < categorias.length - 1 ? '1px solid #F3E8D8' : 'none',
                    }}
                  >
                    <td style={{ padding: '14px 16px', fontSize: 14, fontWeight: 700, color: '#2C1208' }}>
                      {cat.nombre}
                    </td>
                    ...
                    <td style={{ padding: '14px 16px' }}>
                      <span
                        style={{
                          ...
                          fontSize: 12,
                          fontWeight: 700,
                          background: cat.activa ? '#f0fdf4' : '#fef2f2',
                          color: cat.activa ? '#15803d' : '#dc2626',
                        }}
                      >
      ...
      {toast && (
        <div
          style={{
            ...
            borderRadius: 12,
            padding: '12px 18px',
            boxShadow: '0 8px 24px rgba(44,18,8,0.15)',
            display: 'flex',
            alignItems: 'center',
            gap: 8,
            fontFamily: "'Manrope', sans-serif",
    ...
    <label style={{ position: 'relative', display: 'inline-block', width: 44, height: 24, cursor: 'pointer' }}>
      ...
      <span
        style={{
          ...
          inset: 0,
          borderRadius: 99,
          background: checked ? '#C4522A' : '#E2CFB5',
