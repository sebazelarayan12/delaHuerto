...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-4 z-50 bg-[#25D366] rounded-full py-3.5 pr-5 pl-4 flex items-center gap-2.5 text-white font-sans text-[15px] font-bold shadow-[0_6px_20px_rgba(37,211,102,0.45)] transition-all duration-200 hover:scale-105 hover:bg-[#1ebe5d]"
    >
      <WhatsAppIcon />
      <span>Consultas</span>
    </a>
