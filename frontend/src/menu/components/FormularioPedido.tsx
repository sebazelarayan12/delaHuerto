            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Field label="Método de pago" error={errors.metodoPago?.message}>
                <div style={{ display: 'flex', gap: 10 }}>
                  <RadioPill id="ef" value="efectivo" label="Efectivo" icon="payments" register={register} name="metodoPago" />
                  <RadioPill id="tr" value="transferencia" label="Transferencia" icon="account_balance" register={register} name="metodoPago" />
                </div>
              </Field>
              <Field label="Notas (opcional)">
                <textarea
                  placeholder="Sin aceitunas, picante, horario de entrega…"
                  {...register('notas')}
