...
export default function Carrito({ open, onClose, items, total, subtotal, montoDescuento, cantidadTotal, onIncrementar, onDecrementar, onConfirmar }: Props) {
  return (
    <div
      ...
      className={`fixed inset-0 bg-espresso/55 z-50 flex justify-end transition-opacity duration-300 ease-in-out ${open ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}
    >
      <div
